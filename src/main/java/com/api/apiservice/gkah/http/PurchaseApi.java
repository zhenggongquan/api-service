...
public class PurchaseApi {
     ...
     * @return
     */
    public static List<List> getPurData(String url, String privateKey, String token,
                                             String userid, String password, String startDate, String endDate) {
        Map<String, Object> params = new HashMap<>(5);
        params.put("token", "qyfr1c3epstm7bw02gn8jk6a5xdh94vzi");
        params.put("userid", "00276-01");
        params.put("password", "00276-01");
        params.put("begindate", "2019/07/09");
